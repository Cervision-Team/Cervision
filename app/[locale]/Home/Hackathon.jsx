...
const Hackathon = () => {
  ...
  return (
    <>
      <section className="w-full h-auto px-[80px] flex flex-col lg:flex-row items-center justify-between mt-[86px] text-center lg:text-left max-lg:px-[16px] relative">
